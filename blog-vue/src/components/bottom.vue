<template>
  <div id="bottom">
    <div class="line"></div>
    <p id="txt">
      <el-link :underline="false" type="info">© 2020 技术分享类博客&nbsp;&nbsp;</el-link>
      <el-link :underline="false" target="_blank" href="http://www.beian.miit.gov.cn/" type="info">京ICP备19010199号-1</el-link>
    </p>

    <p class="sdfsdf">
      有任何问题请发邮件至
      <el-link :underline="false" href="mailto:1302540061@qq.com">1302540061@qq.com</el-link>
      或 联系站长
      <a
